...
{
    Student st[5];
    st[0].setInfo("Rajib","22-6-1995", "1308013", 150, false);
    st[1].setInfo("Rakib","17-12-1995", "1308010", 550, false);
    st[2].setInfo("Sakib","10-2-1994", "1308004", 1500, true);
    st[3].setInfo("Sumon","2-8-1996", "1308018", 200, false);
    st[4].setInfo("Sujoy","1-1-1994", "1308025", 250, false);
